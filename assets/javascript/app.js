$(document).ready(function() {
  function startScreen() {
    startGame =
      "<p class='text-center mainButton'><a class='btn btn-info btn-md btn-block start-button' href='#' role='button'>Start Quiz</a></p>";
  ...
  $("body").on("click", ".answer", function(event) {
    ...
    if (answerSelected === correctAnswers[questionCount]) {
      clearInterval(theClock), correctAnswer();
    } else {
      clearInterval(theClock), incorrectAnswer();
    }
  });
...
function correctAnswer() {
  wins++;
  gameText =
    "<p class='result'> Time Remaining: <span>" +
    timeLeft +
    "</span></p>" +
    "<p class='result'>Correct! The answer is: " +
    correctAnswers[questionCount] +
    "</p>" +
    gifArray[questionCount];
...
function incorrectAnswer() {
  ...
  gameText =
    ...
    timeLeft +
    "</span></p>" +
    "<p class='result'>Wrong! The answer is: " +
    correctAnswers[questionCount] +
    "</p>" +
    "<img src='assets/images/lose.gif'>";
  $("#questionArea").html(gameText);
...
function timeoutLoss() {
  ...
  gameText =
    ...
    timeLeft +
    "</span></p>" +
    "<p class='result'>You did not submit an answer! The answer is " +
    correctAnswers[questionCount] +
    "</p>" +
    "<img src='assets/images/timesup.gif'>";
  $("#questionArea").html(gameText);
...
function createQuestion() {
  gameText =
    "<p id='timer'>Time Remaining: <span class='timer'>20</span></p><p id='question'>" +
...
function resultScreen() {
  gameText =
    ...
    timeLeft +
    "</span></p>" +
    "<p class='result'>You have made it through the quiz! Here's how you did." +
    "</p>" +
    "<p class='result'>Correct Answers: " +
    wins +
    "</p>" +
    "<p class='result'>Wrong Answers: " +
    losses +
    "</p>" +
    "<p class='result'>Unanswered Questions: " +
    unanswered +
    "</p>" +
...
var answers = [
  ...
  [
    ...
    "Because turbans were not allowed"
  ],
  [
    "Carson, California",
    "Baltimore, Maryland",
